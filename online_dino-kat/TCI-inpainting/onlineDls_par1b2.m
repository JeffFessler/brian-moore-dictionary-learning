function [vars, opts, vars0] = onlineDls_par1b2()
% Syntax:   [vars, opts, vars0] = onlineDls_par1b2();

% Knobs
vars.inpath   = 'data/gstennis.mat';
vars.rawpath  = 'onlineDls_par1b2/data.mat';
vars.outpath  = 'onlineDls_par1b2.mat';
