function [vars, opts, vars0] = onlineDls_npar3b()
% Syntax:   [vars, opts, vars0] = onlineDls_npar3b();

% Knobs
vars.inpath   = 'data/coastguard2.mat';
vars.rawpath  = 'onlineDls_npar3b/data.mat';
vars.outpath  = 'onlineDls_npar3b.mat';
