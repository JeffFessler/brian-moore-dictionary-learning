function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par5f()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par5f();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par5f/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par5f.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = [50, 20];
vars.nIters   = [10, 5];
...
vars.seed     = 1;
vars.lambda   = 0.02 * logspace(-0.5,0.5,5);
vars.mu       = 0.02 * logspace(-0.5,0.5,5);
vars.mu2      = zeros(size(vars.mu));
vars.dr       = nan;
vars.gamma    = 0.9;
vars.gamma2   = 0.9;
...
vars.lambda0  = 0.08;          % override param for 1st rep
vars.mu0      = 0.02;          % override param for 1st rep
