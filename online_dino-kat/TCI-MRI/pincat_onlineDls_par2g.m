function [vars, opts, vars0, opts0] = pincat_onlineDls_par2g()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par2g();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par2g/data.mat';
vars.outpath  = 'pincat_onlineDls_par2g.mat';
vars.T        = 5;
vars.dt       = 1;
