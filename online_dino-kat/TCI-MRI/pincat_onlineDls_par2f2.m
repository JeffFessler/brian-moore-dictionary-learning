function [vars, opts, vars0, opts0] = pincat_onlineDls_par2f2()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par2f2();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par2f2/data.mat';
vars.outpath  = 'pincat_onlineDls_par2f2.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 10;
