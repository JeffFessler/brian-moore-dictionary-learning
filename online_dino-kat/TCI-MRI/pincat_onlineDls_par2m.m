function [vars, opts, vars0, opts0] = pincat_onlineDls_par2m()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par2m();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par2m/data.mat';
vars.outpath  = 'pincat_onlineDls_par2m.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 25;
vars.nIters   = 10;
