function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par4a()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par4a();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par4a/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par4a.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 75;
vars.nIters   = 15;
