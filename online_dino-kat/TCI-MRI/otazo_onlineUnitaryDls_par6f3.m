function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6f3()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6f3();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par6f3/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par6f3.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = [50, 20];
vars.nIters   = [10, 5];
