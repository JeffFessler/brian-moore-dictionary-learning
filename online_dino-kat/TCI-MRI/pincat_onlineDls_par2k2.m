function [vars, opts, vars0, opts0] = pincat_onlineDls_par2k2()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par2k2();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par2k2/data.mat';
vars.outpath  = 'pincat_onlineDls_par2k2.mat';
vars.T        = 5;
vars.dt       = 1;
...
vars.seed     = [1];
vars.lambda   = 0.20 * logspace(-0.25,0.25,5);
vars.mu       = 0.08 * logspace(-0.25,0.25,5);
