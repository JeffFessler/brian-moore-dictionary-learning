function [vars, opts, vars0, opts0] = pincat_onlineDls_par3c()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par3c();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par3c/data.mat';
vars.outpath  = 'pincat_onlineDls_par3c.mat';
vars.T        = 5;
vars.dt       = 1;
