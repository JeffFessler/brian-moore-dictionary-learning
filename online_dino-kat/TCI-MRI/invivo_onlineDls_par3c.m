function [vars, opts, vars0, opts0] = invivo_onlineDls_par3c()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par3c();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par3c/data.mat';
vars.outpath  = 'invivo_onlineDls_par3c.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 100;
vars.nIters   = 20;
