function [vars, opts, vars0, opts0] = invivo_onlineDls_par3f()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par3f();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par3f/data.mat';
vars.outpath  = 'invivo_onlineDls_par3f.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 100;
vars.nIters   = 20;
