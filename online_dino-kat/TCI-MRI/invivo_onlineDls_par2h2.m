function [vars, opts, vars0, opts0] = invivo_onlineDls_par2h2()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par2h2();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par2h2/data.mat';
vars.outpath  = 'invivo_onlineDls_par2h2.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 10;
...
%%%% oracle dictionary %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data = load('dicts/invivo_Dsoup_par1_data3.mat');
opts.D0       = data.Dhat;
