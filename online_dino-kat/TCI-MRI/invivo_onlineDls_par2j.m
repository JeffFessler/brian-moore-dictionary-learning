function [vars, opts, vars0, opts0] = invivo_onlineDls_par2j()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par2j();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par2j/data.mat';
vars.outpath  = 'invivo_onlineDls_par2j.mat';
vars.T        = 5;
vars.dt       = 1;
