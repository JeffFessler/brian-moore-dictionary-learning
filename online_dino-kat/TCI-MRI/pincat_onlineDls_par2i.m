function [vars, opts, vars0, opts0] = pincat_onlineDls_par2i()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par2i();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par2i/data.mat';
vars.outpath  = 'pincat_onlineDls_par2i.mat';
vars.T        = 5;
vars.dt       = 1;
