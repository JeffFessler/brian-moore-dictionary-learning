function [vars, opts, vars0, opts0] = otazo_onlineDls_par2k3()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineDls_par2k3();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineDls_par2k3/data.mat';
vars.outpath  = 'otazo_onlineDls_par2k3.mat';
vars.T        = 5;
vars.dt       = 1;
