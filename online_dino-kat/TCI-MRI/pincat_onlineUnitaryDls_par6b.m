function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par6b()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par6b();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par6b/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par6b.mat';
vars.T        = 5;
vars.dt       = 1;
%vars.nItersi  = 50;
%vars.nIters   = 15;
...
opts.pgap     = [2, 2, 1]; % FOR RUNTIMES ONLY
opts.type     = 'hard';
%opts.dr
