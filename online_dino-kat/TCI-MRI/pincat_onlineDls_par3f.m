function [vars, opts, vars0, opts0] = pincat_onlineDls_par3f()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par3f();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par3f/data.mat';
vars.outpath  = 'pincat_onlineDls_par3f.mat';
vars.T        = 5;
vars.dt       = 1;
