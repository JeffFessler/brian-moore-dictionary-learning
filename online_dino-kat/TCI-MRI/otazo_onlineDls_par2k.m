function [vars, opts, vars0, opts0] = otazo_onlineDls_par2k()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineDls_par2k();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineDls_par2k/data.mat';
vars.outpath  = 'otazo_onlineDls_par2k.mat';
vars.T        = 5;
vars.dt       = 1;
