function [vars, opts, vars0, opts0] = pincat_onlineDls_par3e()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par3e();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par3e/data.mat';
vars.outpath  = 'pincat_onlineDls_par3e.mat';
vars.T        = 5;
vars.dt       = 1;
