function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par1()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par1();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par1/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par1.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 10;
