function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par3c()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par3c();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par3c/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par3c.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 15;
...
vars.seed     = [1];
vars.lambda   = 0.03 * logspace(-0.5,0.5,5);
