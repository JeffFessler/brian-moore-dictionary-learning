function [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par4e()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par4e();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineUnitaryDls_par4e/data.mat';
vars.outpath  = 'invivo_onlineUnitaryDls_par4e.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 100;
vars.nIters   = 20;
