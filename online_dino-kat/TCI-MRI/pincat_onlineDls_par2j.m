function [vars, opts, vars0, opts0] = pincat_onlineDls_par2j()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par2j();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par2j/data.mat';
vars.outpath  = 'pincat_onlineDls_par2j.mat';
vars.T        = 5;
vars.dt       = 1;
