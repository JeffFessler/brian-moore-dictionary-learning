function [vars, opts, vars0, opts0] = otazo_onlineDls_par2h2()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineDls_par2h2();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineDls_par2h2/data.mat';
vars.outpath  = 'otazo_onlineDls_par2h2.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 10;
...
%%%% oracle dictionary %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data = load('dicts/otazo_Dsoup_par1_data4.mat');
opts.D0       = data.Dhat;
