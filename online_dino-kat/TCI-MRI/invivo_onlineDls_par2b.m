function [vars, opts, vars0, opts0] = invivo_onlineDls_par2b()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par2b();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par2b/data.mat';
vars.outpath  = 'invivo_onlineDls_par2b.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 10;
