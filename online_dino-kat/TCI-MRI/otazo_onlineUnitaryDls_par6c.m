function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6c()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6c();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par6c/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par6c.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 15;
