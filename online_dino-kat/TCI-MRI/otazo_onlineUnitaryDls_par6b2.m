function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6b2()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6b2();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par6b2/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par6b2.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 15;
