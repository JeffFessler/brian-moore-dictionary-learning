function [vars, opts, vars0, opts0] = otazo_onlineDls_par2i()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineDls_par2i();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineDls_par2i/data.mat';
vars.outpath  = 'otazo_onlineDls_par2i.mat';
vars.T        = 5;
vars.dt       = 1;
