function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par3c()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par3c();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par3c/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par3c.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 75;
vars.nIters   = 15;
...
vars.seed     = [1];
vars.lambda   = 0.40 * logspace(-0.5,0.5,5);
vars.mu       = 0.05 * logspace(-0.5,0.5,5);
