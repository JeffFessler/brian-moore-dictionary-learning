function [vars, opts, vars0, opts0] = pincat_onlineDls_par2n()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par2n();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par2n/data.mat';
vars.outpath  = 'pincat_onlineDls_par2n.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 100;
vars.nIters   = 20;
