function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par6d()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par6d();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par6d/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par6d.mat';
vars.T        = 10; % MORE
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 15;
