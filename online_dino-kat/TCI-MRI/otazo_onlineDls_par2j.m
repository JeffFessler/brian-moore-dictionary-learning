function [vars, opts, vars0, opts0] = otazo_onlineDls_par2j()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineDls_par2j();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineDls_par2j/data.mat';
vars.outpath  = 'otazo_onlineDls_par2j.mat';
vars.T        = 5;
vars.dt       = 1;
