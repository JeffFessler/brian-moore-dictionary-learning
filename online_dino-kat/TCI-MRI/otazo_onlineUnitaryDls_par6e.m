function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6e()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6e();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par6e/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par6e.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = [75, 50];
vars.nIters   = [15, 10];
