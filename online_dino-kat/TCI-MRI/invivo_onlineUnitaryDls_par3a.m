function [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par3a()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par3a();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineUnitaryDls_par3a/data.mat';
vars.outpath  = 'invivo_onlineUnitaryDls_par3a.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 100;
vars.nIters   = 20;
