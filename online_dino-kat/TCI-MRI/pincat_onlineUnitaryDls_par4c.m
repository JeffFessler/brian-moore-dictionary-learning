function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par4c()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par4c();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par4c/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par4c.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 75;
vars.nIters   = 15;
