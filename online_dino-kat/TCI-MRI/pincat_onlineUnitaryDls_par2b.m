function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par2b()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par2b();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par2b/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par2b.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 20; % MORE
