function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par6b2()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par6b2();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par6b2/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par6b2.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 15;
