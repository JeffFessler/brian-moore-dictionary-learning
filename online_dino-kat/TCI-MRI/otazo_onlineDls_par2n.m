function [vars, opts, vars0, opts0] = otazo_onlineDls_par2n()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineDls_par2n();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineDls_par2n/data.mat';
vars.outpath  = 'otazo_onlineDls_par2n.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 75;
vars.nIters   = 15;
...
vars.seed     = [1];
vars.lambda   = 0.035 * logspace(-0.25,0.25,5);
