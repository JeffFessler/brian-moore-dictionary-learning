function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6f2()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6f2();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par6f2/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par6f2.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = [75, 50]; % MORE
vars.nIters   = [15, 10]; % MORE
vars.nIters0  = 0;
vars.np       = 0;
vars.SNR      = inf;
vars.nReps    = 2;
