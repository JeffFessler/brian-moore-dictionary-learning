function [vars, opts, vars0, opts0] = pincat_onlineDls_par2f()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par2f();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par2f/data.mat';
vars.outpath  = 'pincat_onlineDls_par2f.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 10;
