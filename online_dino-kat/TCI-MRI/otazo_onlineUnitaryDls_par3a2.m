function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par3a2()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par3a2();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par3a2/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par3a2.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 100;
vars.nIters   = 20;
