function [vars, opts, vars0, opts0] = invivo_onlineDls_par3d()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par3d();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par3d/data.mat';
vars.outpath  = 'invivo_onlineDls_par3d.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 100;
vars.nIters   = 20;
