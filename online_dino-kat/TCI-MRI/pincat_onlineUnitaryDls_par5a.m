function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par5a()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par5a();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par5a/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par5a.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 75;
vars.nIters   = 15;
...
vars.seed     = [1];
vars.lambda   = 0.40 * logspace(-0.7,0.7,5);
vars.mu       = 0.05 * logspace(-0.7,0.7,5);
