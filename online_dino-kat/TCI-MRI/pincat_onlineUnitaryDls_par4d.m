function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par4d()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par4d();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par4d/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par4d.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 75;
vars.nIters   = 15;
