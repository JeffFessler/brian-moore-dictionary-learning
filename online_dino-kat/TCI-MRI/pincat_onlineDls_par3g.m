function [vars, opts, vars0, opts0] = pincat_onlineDls_par3g()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par3g();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par3g/data.mat';
vars.outpath  = 'pincat_onlineDls_par3g.mat';
vars.T        = 5;
vars.dt       = 1;
