function [vars, opts, vars0, opts0] = invivo_onlineDls_par2k2()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par2k2();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par2k2/data.mat';
vars.outpath  = 'invivo_onlineDls_par2k2.mat';
vars.T        = 5;
vars.dt       = 1;
