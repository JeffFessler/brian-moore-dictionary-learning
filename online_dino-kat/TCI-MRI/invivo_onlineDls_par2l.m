function [vars, opts, vars0, opts0] = invivo_onlineDls_par2l()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par2l();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par2l/data.mat';
vars.outpath  = 'invivo_onlineDls_par2l.mat';
vars.T        = 5;
vars.dt       = 1;
