function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par3b()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par3b();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par3b/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par3b.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 25;
vars.nIters   = 10;
