function [vars, opts, vars0, opts0] = invivo_onlineDls_par2i()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par2i();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par2i/data.mat';
vars.outpath  = 'invivo_onlineDls_par2i.mat';
vars.T        = 5;
vars.dt       = 1;
