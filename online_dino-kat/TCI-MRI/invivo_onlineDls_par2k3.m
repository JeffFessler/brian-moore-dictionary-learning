function [vars, opts, vars0, opts0] = invivo_onlineDls_par2k3()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par2k3();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par2k3/data.mat';
vars.outpath  = 'invivo_onlineDls_par2k3.mat';
vars.T        = 5;
vars.dt       = 1;
