function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6d()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par6d();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par6d/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par6d.mat';
vars.T        = 10; % MORE
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 15;
