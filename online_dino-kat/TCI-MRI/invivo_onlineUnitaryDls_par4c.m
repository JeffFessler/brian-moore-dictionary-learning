function [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par4c()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par4c();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineUnitaryDls_par4c/data.mat';
vars.outpath  = 'invivo_onlineUnitaryDls_par4c.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 100;
vars.nIters   = 20;
