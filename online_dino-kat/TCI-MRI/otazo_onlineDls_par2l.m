function [vars, opts, vars0, opts0] = otazo_onlineDls_par2l()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineDls_par2l();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineDls_par2l/data.mat';
vars.outpath  = 'otazo_onlineDls_par2l.mat';
vars.T        = 5;
vars.dt       = 1;
