function [vars, opts, vars0, opts0] = otazo_onlineDls_par2g()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineDls_par2g();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineDls_par2g/data.mat';
vars.outpath  = 'otazo_onlineDls_par2g.mat';
vars.T        = 5;
vars.dt       = 1;
