function [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par4d()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par4d();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineUnitaryDls_par4d/data.mat';
vars.outpath  = 'invivo_onlineUnitaryDls_par4d.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 100;
vars.nIters   = 20;
