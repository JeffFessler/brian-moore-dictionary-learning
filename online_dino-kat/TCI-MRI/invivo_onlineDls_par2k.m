function [vars, opts, vars0, opts0] = invivo_onlineDls_par2k()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineDls_par2k();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineDls_par2k/data.mat';
vars.outpath  = 'invivo_onlineDls_par2k.mat';
vars.T        = 5;
vars.dt       = 1;
