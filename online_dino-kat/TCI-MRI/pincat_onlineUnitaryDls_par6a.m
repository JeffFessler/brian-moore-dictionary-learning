function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par6a()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par6a();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par6a/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par6a.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 15;
