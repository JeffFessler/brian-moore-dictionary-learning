function [vars, opts, vars0, opts0] = pincat_onlineDls_par2k()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineDls_par2k();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineDls_par2k/data.mat';
vars.outpath  = 'pincat_onlineDls_par2k.mat';
vars.T        = 5;
vars.dt       = 1;
