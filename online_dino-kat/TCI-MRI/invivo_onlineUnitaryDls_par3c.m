function [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par3c()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par3c();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineUnitaryDls_par3c/data.mat';
vars.outpath  = 'invivo_onlineUnitaryDls_par3c.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 100;
vars.nIters   = 20;
...
vars.seed     = [1];
vars.lambda   = 0.010 * logspace(-0.5,0.5,5);
vars.mu       = 0.025 * logspace(-0.5,0.5,5);
