function [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par5c()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineUnitaryDls_par5c();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineUnitaryDls_par5c/data.mat';
vars.outpath  = 'otazo_onlineUnitaryDls_par5c.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 75;
vars.nIters   = 15;
