function [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par1()
% Syntax:   [vars, opts, vars0, opts0] = invivo_onlineUnitaryDls_par1();

% Knobs
vars.inpath   = 'data/invivo_full.mat';
vars.rawpath  = 'invivo_onlineUnitaryDls_par1/data.mat';
vars.outpath  = 'invivo_onlineUnitaryDls_par1.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 10;
