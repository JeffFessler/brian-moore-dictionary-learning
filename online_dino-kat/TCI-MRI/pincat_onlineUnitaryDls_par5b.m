function [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par5b()
% Syntax:   [vars, opts, vars0, opts0] = pincat_onlineUnitaryDls_par5b();

% Knobs
vars.inpath   = 'data/pincat_full.mat';
vars.rawpath  = 'pincat_onlineUnitaryDls_par5b/data.mat';
vars.outpath  = 'pincat_onlineUnitaryDls_par5b.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 75;
vars.nIters   = 15;
