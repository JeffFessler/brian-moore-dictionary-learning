function [vars, opts, vars0, opts0] = otazo_onlineDls_par3c()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineDls_par3c();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineDls_par3c/data.mat';
vars.outpath  = 'otazo_onlineDls_par3c.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 10;
