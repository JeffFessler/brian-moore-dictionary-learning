function [vars, opts, vars0, opts0] = otazo_onlineDls_par6()
% Syntax:   [vars, opts, vars0, opts0] = otazo_onlineDls_par6();

% Knobs
vars.inpath   = 'data/otazo_full.mat';
vars.rawpath  = 'otazo_onlineDls_par6/data.mat';
vars.outpath  = 'otazo_onlineDls_par6.mat';
vars.T        = 5;
vars.dt       = 1;
vars.nItersi  = 50;
vars.nIters   = 10;
