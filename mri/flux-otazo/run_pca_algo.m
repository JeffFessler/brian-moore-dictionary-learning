function [NRMSE recon Xtrue ROIs] = run_pca_algo(p,SNR,seed,inpath,r,proxS,lambdaS,algoStr,T)
% Syntax:   [NRMSE recon Xtrue ROIs] = run_pca_algo(p,SNR,seed,inpath,r,proxS,lambdaS,algoStr,T);
