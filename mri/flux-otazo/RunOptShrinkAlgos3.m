...
outpath = '/home/brimoor/Research/otazo/opt_LpS_mixed21/data.mat'; % Output data path
%--------------------------------------------------------------------------
...
for i = 1:Ninds
    ...
    [~,recon,Xtrue,ROIs] = run_optshrink_algo(p(i),SNR(i),seed(i),inpath,r(i),proxS,lambdaS(i),algoStr,T);
    [ny nx] = size(ROIs{1});
    nt = size(Xtrue,2);
