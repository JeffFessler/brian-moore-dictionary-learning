function [vars, opts, vars0, opts0] = LASSI_full_par3c()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par3c();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par3c/data.mat';
vars.outpath   = 'LASSI_full_par3c.mat';
