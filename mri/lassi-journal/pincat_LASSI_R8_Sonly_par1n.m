function [vars, opts] = pincat_LASSI_R8_Sonly_par1n()
% Syntax:   [vars, opts] = pincat_LASSI_R8_Sonly_par1n();

% Knobs
vars.inpath   = 'pincat_R8n.mat';
vars.initpath = 'pincat_R8n_ktslr_nrmse.mat';
vars.rawpath  = 'pincat_LASSI_R8_Sonly_par1n/data.mat';
vars.outpath  = 'pincat_LASSI_R8_Sonly_par1n.mat';
vars.r        = nan;
vars.lambdaL  = 1e100;
