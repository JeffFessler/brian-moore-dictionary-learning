function [vars, opts, vars0, opts0] = pincat_LASSI_full_par2()
% Syntax:   [vars, opts, vars0, opts0] = pincat_LASSI_full_par2();

% Knobs
vars.inpath   = 'pincat_full.mat';
vars.rawpath  = 'pincat_LASSI_full_par2/data.mat';
vars.outpath  = 'pincat_LASSI_full_par2.mat';
