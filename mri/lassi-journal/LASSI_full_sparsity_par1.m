function [vars, opts, vars0, opts0] = LASSI_full_sparsity_par1()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_sparsity_par1();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_sparsity_par1/data.mat';
vars.outpath   = 'LASSI_full_sparsity_par1.mat';
...
vars.lambdaB0  = 0.03 * logspace(-1,1,9);
vars.dr        = 1;
vars.nIters    = 50;
