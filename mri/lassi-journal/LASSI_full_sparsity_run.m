function LASSI_full_sparsity_run(parFcn,idx)
% Syntax: LASSI_full_sparsity_run();
%         LASSI_full_sparsity_run(parFcn,idx);
...
ps       = vars.ps(ii);
seed     = vars.seed(jj);
lambdaB  = vars.lambdaB(kk);
lambdaB0 = vars.lambdaB0(kk);
