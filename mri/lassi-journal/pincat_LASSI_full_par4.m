function [vars, opts, vars0, opts0] = pincat_LASSI_full_par4()
% Syntax:   [vars, opts, vars0, opts0] = pincat_LASSI_full_par4();

% Knobs
vars.inpath   = 'pincat_full.mat';
vars.rawpath  = 'pincat_LASSI_full_par4/data.mat';
vars.outpath  = 'pincat_LASSI_full_par4.mat';
