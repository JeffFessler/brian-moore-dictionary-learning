function [vars, opts, vars0, opts0] = LASSI_full_Sonly_par2()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Sonly_par2();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Sonly_par2/data.mat';
vars.outpath   = 'LASSI_full_Sonly_par2.mat';
