function [vars, opts] = LASSI_R8_Sonly_par6b()
% Syntax:   [vars, opts] = LASSI_R8_Sonly_par6b();

% Knobs
vars.inpath   = 'otazo_R8.mat';
vars.initpath = 'otazo_R8_lps_visual.mat';
vars.rawpath  = 'LASSI_R8_Sonly_par6b/data.mat';
vars.outpath  = 'LASSI_R8_Sonly_par6b.mat';
vars.r        = nan;
vars.lambdaL  = 1e100;
