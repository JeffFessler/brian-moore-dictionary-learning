function [vars, opts, vars0, opts0] = LASSI_full_Sonly_par7f()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Sonly_par7f();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Sonly_par7f/data.mat';
vars.outpath   = 'LASSI_full_Sonly_par7f.mat';
