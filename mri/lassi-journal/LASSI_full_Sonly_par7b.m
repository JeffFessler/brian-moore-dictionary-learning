function [vars, opts, vars0, opts0] = LASSI_full_Sonly_par7b()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Sonly_par7b();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Sonly_par7b/data.mat';
vars.outpath   = 'LASSI_full_Sonly_par7b.mat';
