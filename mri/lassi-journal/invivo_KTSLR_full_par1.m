function [vars, opts] = invivo_KTSLR_full_par1()
% Syntax:   [vars, opts] = invivo_KTSLR_full_par1();

% Knobs
vars.inpath   = 'invivo_full.mat';
vars.rawpath  = 'invivo_KTSLR_full_par1/data.mat';
vars.outpath  = 'invivo_KTSLR_full_par1.mat';
