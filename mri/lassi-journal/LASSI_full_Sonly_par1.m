function [vars, opts, vars0, opts0] = LASSI_full_Sonly_par1()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Sonly_par1();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Sonly_par1/data.mat';
vars.outpath   = 'LASSI_full_Sonly_par1.mat';
