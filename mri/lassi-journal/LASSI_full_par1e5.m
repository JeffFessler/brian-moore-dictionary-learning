function [vars, opts, vars0, opts0] = LASSI_full_par1e5()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1e5();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1e5/data.mat';
vars.outpath   = 'LASSI_full_par1e5.mat';
