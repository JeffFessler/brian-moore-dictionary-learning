function [vars, opts, vars0, opts0] = LASSI_full_Sonly_par2c()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Sonly_par2c();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Sonly_par2c/data.mat';
vars.outpath   = 'LASSI_full_Sonly_par2c.mat';
