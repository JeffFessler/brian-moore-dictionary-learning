function [vars, opts] = pincat_LASSI_R8_par2()
% Syntax:   [vars, opts] = pincat_LASSI_R8_par2();

% Knobs
vars.inpath   = 'pincat_R8.mat';
vars.initpath = 'pincat_R8_lps_nrmse.mat';
vars.rawpath  = 'pincat_LASSI_R8_par2/data.mat';
vars.outpath  = 'pincat_LASSI_R8_par2.mat';
vars.r        = nan;
