function [vars, opts] = pincat_LASSI_R8_par3nb()
% Syntax:   [vars, opts] = pincat_LASSI_R8_par3nb();

% Knobs
vars.inpath   = 'pincat_R8n.mat';
vars.initpath = 'pincat_R8n_lps_nrmse.mat';
vars.rawpath  = 'pincat_LASSI_R8_par3nb/data.mat';
vars.outpath  = 'pincat_LASSI_R8_par3nb.mat';
vars.r        = [1, 2];
vars.lambdaL  = nan;
