function [vars, opts, vars0, opts0] = LASSI_full_par2b()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par2b();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par2b/data.mat';
vars.outpath   = 'LASSI_full_par2b.mat';
