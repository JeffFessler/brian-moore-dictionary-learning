function [vars, opts, vars0, opts0] = LASSI_full_par2d()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par2d();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par2d/data.mat';
vars.outpath   = 'LASSI_full_par2d.mat';
