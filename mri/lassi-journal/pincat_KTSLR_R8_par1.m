function [vars, opts] = pincat_KTSLR_R8_par1()
% Syntax:   [vars, opts] = pincat_KTSLR_R8_par1();

% Knobs
vars.inpath   = 'pincat_R8.mat';
vars.rawpath  = 'pincat_KTSLR_R8_par1/data.mat';
vars.outpath  = 'pincat_KTSLR_R8_par1.mat';
vars.p        = [0.1, 0.5, 1];
