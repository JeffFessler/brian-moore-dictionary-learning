function LASSI_full_sparsity_agg(parFcn)
% Syntax: LASSI_full_sparsity_agg(parFcn);
...
nIters = vars.nIters;
stats.cost     = nan(nP,nS,nB,nIters);
stats.nrmse    = nan(nP,nS,nB,nIters);
stats.delta    = nan(nP,nS,nB,nIters);
stats.sparsity = nan(nP,nS,nB,nIters);
stats.time     = nan(nP,nS,nB,nIters);
