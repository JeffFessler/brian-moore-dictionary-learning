function [vars, opts, vars0, opts0] = recon_otazo_full_par206()
% Syntax:   [vars, opts, vars0, opts0] = recon_otazo_full_par206();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.outpath   = 'recon_otazo_full_par206.mat';
...
vars.lambdaB0  = 0.03;
vars.dr        = 1;
vars.nIters    = 200; % Extra iterations
