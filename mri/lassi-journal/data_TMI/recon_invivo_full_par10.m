function [vars, opts, vars0, opts0] = recon_invivo_full_par10()
% Syntax:   [vars, opts, vars0, opts0] = recon_invivo_full_par10();

% Knobs
vars.inpath   = 'invivo_full.mat';
vars.outpath  = 'recon_invivo_full_par10.mat';
