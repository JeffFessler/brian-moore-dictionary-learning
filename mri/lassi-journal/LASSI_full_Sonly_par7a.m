function [vars, opts, vars0, opts0] = LASSI_full_Sonly_par7a()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Sonly_par7a();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Sonly_par7a/data.mat';
vars.outpath   = 'LASSI_full_Sonly_par7a.mat';
