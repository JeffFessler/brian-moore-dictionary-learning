function [vars, opts, vars0, opts0] = LASSI_full_par1i()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1i();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1i/data.mat';
vars.outpath   = 'LASSI_full_par1i.mat';
