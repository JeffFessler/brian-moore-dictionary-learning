function [vars, opts] = LASSI_R8_Sonly_par6c()
% Syntax:   [vars, opts] = LASSI_R8_Sonly_par6c();

% Knobs
vars.inpath   = 'otazo_R8.mat';
vars.initpath = 'otazo_R8_lps_visual.mat';
vars.rawpath  = 'LASSI_R8_Sonly_par6c/data.mat';
vars.outpath  = 'LASSI_R8_Sonly_par6c.mat';
vars.r        = nan;
vars.lambdaL  = 1e100;
vars.lambdaS  = 0.015;
vars.lambdaB  = 0.025;
