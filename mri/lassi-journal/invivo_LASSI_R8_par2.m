function [vars, opts] = invivo_LASSI_R8_par2()
% Syntax:   [vars, opts] = invivo_LASSI_R8_par2();

% Knobs
vars.inpath   = 'invivo_R8.mat';
vars.initpath = 'invivo_R8_lps_nrmse.mat';
vars.rawpath  = 'invivo_LASSI_R8_par2/data.mat';
vars.outpath  = 'invivo_LASSI_R8_par2.mat';
vars.r        = nan;
