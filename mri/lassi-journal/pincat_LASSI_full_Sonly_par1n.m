function [vars, opts, vars0, opts0] = pincat_LASSI_full_Sonly_par1n()
% Syntax:   [vars, opts, vars0, opts0] = pincat_LASSI_full_Sonly_par1n();

% Knobs
vars.inpath   = 'pincat_full.mat';
vars.rawpath  = 'pincat_LASSI_full_Sonly_par1n/data.mat';
vars.outpath  = 'pincat_LASSI_full_Sonly_par1n.mat';
