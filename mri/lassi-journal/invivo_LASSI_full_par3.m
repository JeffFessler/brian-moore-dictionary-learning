function [vars, opts, vars0, opts0] = invivo_LASSI_full_par3()
% Syntax:   [vars, opts, vars0, opts0] = invivo_LASSI_full_par3();

% Knobs
vars.inpath   = 'invivo_full.mat';
vars.rawpath  = 'invivo_LASSI_full_par3/data.mat';
vars.outpath  = 'invivo_LASSI_full_par3.mat';
