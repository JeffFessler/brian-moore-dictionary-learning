function [vars, opts, vars0, opts0] = LASSI_full_par1eb()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1eb();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1eb/data.mat';
vars.outpath   = 'LASSI_full_par1eb.mat';
