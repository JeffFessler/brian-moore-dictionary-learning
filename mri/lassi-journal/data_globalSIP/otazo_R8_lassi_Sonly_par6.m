function [vars, opts] = otazo_R8_lassi_Sonly_par6()
% Syntax:   [vars, opts] = otazo_R8_lassi_Sonly_par6();

% Knobs
vars.inpath   = 'otazo_R8.mat';
vars.initpath = 'otazo_R8_lps_mse.mat';
vars.rawpath  = 'otazo_R8_lassi_Sonly_par6/data.mat';
vars.outpath  = 'otazo_R8_lassi_Sonly_par6.mat';
vars.r        = nan;
vars.lambdaL  = 1e100;
vars.lambdaS  = 0.474;
vars.lambdaB  = 0.008;
