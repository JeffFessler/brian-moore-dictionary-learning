function [vars, opts] = pincat_LASSI_R8_par2nb()
% Syntax:   [vars, opts] = pincat_LASSI_R8_par2nb();

% Knobs
vars.inpath   = 'pincat_R8n.mat';
vars.initpath = 'pincat_R8n_lps_nrmse.mat';
vars.rawpath  = 'pincat_LASSI_R8_par2nb/data.mat';
vars.outpath  = 'pincat_LASSI_R8_par2nb.mat';
vars.r        = nan;
