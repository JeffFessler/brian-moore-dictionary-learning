function [vars, opts] = pincat_LASSI_R8_par1b()
% Syntax:   [vars, opts] = pincat_LASSI_R8_par1b();

% Knobs
vars.inpath   = 'pincat_R8.mat';
vars.initpath = 'pincat_R8_lps_nrmse.mat';
vars.rawpath  = 'pincat_LASSI_R8_par1b/data.mat';
vars.outpath  = 'pincat_LASSI_R8_par1b.mat';
vars.r        = nan;
vars.lambdaL  = [0.05, 0.06, 0.08, 0.10];
