function [vars, opts, vars0, opts0] = LASSI_full_par1c3()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1c3();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1c3/data.mat';
vars.outpath   = 'LASSI_full_par1c3.mat';
