function [vars, opts] = pincat_KTSLR_full_par1n()
% Syntax:   [vars, opts] = pincat_KTSLR_full_par1n();

% Knobs
vars.inpath   = 'pincat_full.mat';
vars.rawpath  = 'pincat_KTSLR_full_par1n/data.mat';
vars.outpath  = 'pincat_KTSLR_full_par1n.mat';
