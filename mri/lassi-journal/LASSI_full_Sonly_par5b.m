function [vars, opts, vars0, opts0] = LASSI_full_Sonly_par5b()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Sonly_par5b();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Sonly_par5b/data.mat';
vars.outpath   = 'LASSI_full_Sonly_par5b.mat';
