function [vars, opts, vars0, opts0] = pincat_LASSI_full_par3n()
% Syntax:   [vars, opts, vars0, opts0] = pincat_LASSI_full_par3n();

% Knobs
vars.inpath   = 'pincat_full.mat';
vars.rawpath  = 'pincat_LASSI_full_par3n/data.mat';
vars.outpath  = 'pincat_LASSI_full_par3n.mat';
