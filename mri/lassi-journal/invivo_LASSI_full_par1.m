function [vars, opts, vars0, opts0] = invivo_LASSI_full_par1()
% Syntax:   [vars, opts, vars0, opts0] = invivo_LASSI_full_par1();

% Knobs
vars.inpath   = 'invivo_full.mat';
vars.rawpath  = 'invivo_LASSI_full_par1/data.mat';
vars.outpath  = 'invivo_LASSI_full_par1.mat';
