function [vars, opts, vars0, opts0] = invivo_LASSI_full_par2()
% Syntax:   [vars, opts, vars0, opts0] = invivo_LASSI_full_par2();

% Knobs
vars.inpath   = 'invivo_full.mat';
vars.rawpath  = 'invivo_LASSI_full_par2/data.mat';
vars.outpath  = 'invivo_LASSI_full_par2.mat';
