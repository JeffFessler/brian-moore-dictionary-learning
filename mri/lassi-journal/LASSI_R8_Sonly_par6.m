function [vars, opts] = LASSI_R8_Sonly_par6()
% Syntax:   [vars, opts] = LASSI_R8_Sonly_par6();

% Knobs
vars.inpath   = 'otazo_R8.mat';
vars.initpath = 'otazo_R8_lps_visual.mat';
vars.rawpath  = 'LASSI_R8_Sonly_par6/data.mat';
vars.outpath  = 'LASSI_R8_Sonly_par6.mat';
vars.r        = nan;
vars.lambdaL  = 1e100;
