function [vars, opts, vars0, opts0] = LASSI_full_par1b2()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1b2();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1b2/data.mat';
vars.outpath   = 'LASSI_full_par1b2.mat';
...
opts.D0       = dctmtx(prod(opts.pdim));        % Non-separable DCT
