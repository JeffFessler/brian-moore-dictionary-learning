function [vars, opts] = LASSI_R8_Sonly_par4()
% Syntax:   [vars, opts] = LASSI_R8_Sonly_par4();

% Knobs
vars.inpath   = 'otazo_R8.mat';
vars.initpath = 'otazo_R8_lps_visual.mat';
vars.rawpath  = 'LASSI_R8_Sonly_par4/data.mat';
vars.outpath  = 'LASSI_R8_Sonly_par4.mat';
vars.r        = nan;
vars.lambdaL  = 1e100;
...
opts.pdim     = [8, 8, 5];
opts.pgap     = [2, 2, 2];
opts.np       = 160; rng(1); % Overcomplete dictionary
opts.type     = 'hard';
%opts.dr      = dr;
