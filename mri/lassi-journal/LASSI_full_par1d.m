function [vars, opts, vars0, opts0] = LASSI_full_par1d()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1d();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1d/data.mat';
vars.outpath   = 'LASSI_full_par1d.mat';
