function [vars, opts] = pincat_LASSI_R8_par1nh()
% Syntax:   [vars, opts] = pincat_LASSI_R8_par1nh();

% Knobs
vars.inpath   = 'pincat_R8n.mat';
vars.initpath = 'pincat_R8n_ktslr_nrmse_0X.mat'; % L = 0, S = X
vars.rawpath  = 'pincat_LASSI_R8_par1nh/data.mat';
vars.outpath  = 'pincat_LASSI_R8_par1nh.mat';
vars.r        = nan;
