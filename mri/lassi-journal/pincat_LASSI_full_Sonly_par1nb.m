function [vars, opts, vars0, opts0] = pincat_LASSI_full_Sonly_par1nb()
% Syntax:   [vars, opts, vars0, opts0] = pincat_LASSI_full_Sonly_par1nb();

% Knobs
vars.inpath   = 'pincat_full.mat';
vars.rawpath  = 'pincat_LASSI_full_Sonly_par1nb/data.mat';
vars.outpath  = 'pincat_LASSI_full_Sonly_par1nb.mat';
