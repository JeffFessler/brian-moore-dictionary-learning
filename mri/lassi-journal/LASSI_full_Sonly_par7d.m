function [vars, opts, vars0, opts0] = LASSI_full_Sonly_par7d()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Sonly_par7d();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Sonly_par7d/data.mat';
vars.outpath   = 'LASSI_full_Sonly_par7d.mat';
