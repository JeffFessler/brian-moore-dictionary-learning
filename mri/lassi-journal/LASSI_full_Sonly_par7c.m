function [vars, opts, vars0, opts0] = LASSI_full_Sonly_par7c()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Sonly_par7c();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Sonly_par7c/data.mat';
vars.outpath   = 'LASSI_full_Sonly_par7c.mat';
