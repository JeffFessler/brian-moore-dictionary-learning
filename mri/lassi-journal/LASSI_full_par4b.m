function [vars, opts, vars0, opts0] = LASSI_full_par4b()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par4b();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par4b/data.mat';
vars.outpath   = 'LASSI_full_par4b.mat';
