function [vars, opts, vars0, opts0] = LASSI_full_par1ec()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1ec();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1ec/data.mat';
vars.outpath   = 'LASSI_full_par1ec.mat';
