function [vars, opts] = invivo_LASSI_R8_par3()
% Syntax:   [vars, opts] = invivo_LASSI_R8_par3();

% Knobs
vars.inpath   = 'invivo_R8.mat';
vars.initpath = 'invivo_R8_lps_nrmse.mat';
vars.rawpath  = 'invivo_LASSI_R8_par3/data.mat';
vars.outpath  = 'invivo_LASSI_R8_par3.mat';
vars.r        = [1, 2, 3, 4, 5];
vars.lambdaL  = nan;
