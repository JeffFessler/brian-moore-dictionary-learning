function [vars, opts, vars0, opts0] = LASSI_full_par2e()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par2e();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par2e/data.mat';
vars.outpath   = 'LASSI_full_par2e.mat';
