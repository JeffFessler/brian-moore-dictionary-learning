function [vars, opts] = pincat_LASSI_R8_par3()
% Syntax:   [vars, opts] = pincat_LASSI_R8_par3();

% Knobs
vars.inpath   = 'pincat_R8.mat';
vars.initpath = 'pincat_R8_lps_nrmse.mat';
vars.rawpath  = 'pincat_LASSI_R8_par3/data.mat';
vars.outpath  = 'pincat_LASSI_R8_par3.mat';
vars.r        = [1, 3, 5, 7, 9];
vars.lambdaL  = nan;
