function [vars, opts] = LASSI_R8_Sonly_par5()
% Syntax:   [vars, opts] = LASSI_R8_Sonly_par5();

% Knobs
vars.inpath   = 'otazo_R8.mat';
vars.initpath = 'otazo_R8_lps_visual.mat';
vars.rawpath  = 'LASSI_R8_Sonly_par5/data.mat';
vars.outpath  = 'LASSI_R8_Sonly_par5.mat';
vars.r        = nan;
vars.lambdaL  = 1e100;
...
%opts.sdim    = [ny, nx, nt];
opts.pdim     = [8, 8, 5];
opts.pgap     = [4, 4, 4]; % Larger patch strides
opts.type     = 'hard';
%opts.dr      = dr;
