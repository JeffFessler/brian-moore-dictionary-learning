function [vars, opts, vars0, opts0] = LASSI_full_par1ed()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1ed();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1ed/data.mat';
vars.outpath   = 'LASSI_full_par1ed.mat';
