function [vars, opts, vars0, opts0] = invivo_LASSI_full_par1c()
% Syntax:   [vars, opts, vars0, opts0] = invivo_LASSI_full_par1c();

% Knobs
vars.inpath   = 'invivo_full.mat';
vars.rawpath  = 'invivo_LASSI_full_par1c/data.mat';
vars.outpath  = 'invivo_LASSI_full_par1c.mat';
