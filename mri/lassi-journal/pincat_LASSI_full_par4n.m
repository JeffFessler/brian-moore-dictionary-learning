function [vars, opts, vars0, opts0] = pincat_LASSI_full_par4n()
% Syntax:   [vars, opts, vars0, opts0] = pincat_LASSI_full_par4n();

% Knobs
vars.inpath   = 'pincat_full.mat';
vars.rawpath  = 'pincat_LASSI_full_par4n/data.mat';
vars.outpath  = 'pincat_LASSI_full_par4n.mat';
