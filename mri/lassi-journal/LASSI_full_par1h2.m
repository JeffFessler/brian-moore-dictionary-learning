function [vars, opts, vars0, opts0] = LASSI_full_par1h2()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1h2();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1h2/data.mat';
vars.outpath   = 'LASSI_full_par1h2.mat';
vars.ps        = 1 ./ [4, 8, 12, 16, 20, 24];
vars.seed      = 1:5;
vars.r         = nan;
vars.p         = 0; % Rank penalty
vars.lambdaL   = 3.00;
vars.lambdaS   = 0.02;
vars.lambdaB   = 0.03;
vars.lambdaB0  = 0.03;
