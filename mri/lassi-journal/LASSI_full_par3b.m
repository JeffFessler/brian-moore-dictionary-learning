function [vars, opts, vars0, opts0] = LASSI_full_par3b()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par3b();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par3b/data.mat';
vars.outpath   = 'LASSI_full_par3b.mat';
