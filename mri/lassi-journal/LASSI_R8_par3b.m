function [vars, opts] = LASSI_R8_par3b()
% Syntax:   [vars, opts] = LASSI_R8_par3b();

% Knobs
vars.inpath   = 'otazo_R8.mat';
vars.initpath = 'otazo_R8_lps_visual.mat';
vars.rawpath  = 'LASSI_R8_par3b/data.mat';
vars.outpath  = 'LASSI_R8_par3b.mat';
vars.r        = 1;
vars.lambdaL  = nan;
vars.lambdaS  = [0.015, 0.02, 0.025, 0.03];
