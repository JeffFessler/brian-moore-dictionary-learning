function [vars, opts, vars0, opts0] = invivo_LASSI_full_Sonly_par1b()
% Syntax:   [vars, opts, vars0, opts0] = invivo_LASSI_full_Sonly_par1b();

% Knobs
vars.inpath   = 'invivo_full.mat';
vars.rawpath  = 'invivo_LASSI_full_Sonly_par1b/data.mat';
vars.outpath  = 'invivo_LASSI_full_Sonly_par1b.mat';
