function [vars, opts, vars0, opts0] = LASSI_full_par1ee()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1ee();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1ee/data.mat';
vars.outpath   = 'LASSI_full_par1ee.mat';
