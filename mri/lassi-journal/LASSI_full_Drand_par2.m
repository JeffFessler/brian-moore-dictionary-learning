function [vars, opts, vars0, opts0] = LASSI_full_Drand_par2()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Drand_par2();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Drand_par2/data.mat';
vars.outpath   = 'LASSI_full_Drand_par2.mat';
vars.ps        = 1 ./ [4, 8, 12, 16, 20, 24];
vars.seed      = 3;
vars.D0seed    = 1:5;                               % Random seed for D0
vars.r         = nan;
vars.lambdaL   = 0.5;
vars.lambdaS   = 0.02;
vars.lambdaB   = 0.03;
