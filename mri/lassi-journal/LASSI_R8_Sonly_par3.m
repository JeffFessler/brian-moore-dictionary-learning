function [vars, opts] = LASSI_R8_Sonly_par3()
% Syntax:   [vars, opts] = LASSI_R8_Sonly_par3();

% Knobs
vars.inpath   = 'otazo_R8.mat';
vars.initpath = 'otazo_R8_lps_visual.mat';
vars.rawpath  = 'LASSI_R8_Sonly_par3/data.mat';
vars.outpath  = 'LASSI_R8_Sonly_par3.mat';
vars.r        = nan;
vars.lambdaL  = 1e100;
