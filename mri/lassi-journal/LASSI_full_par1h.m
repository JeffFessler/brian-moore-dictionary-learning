function [vars, opts, vars0, opts0] = LASSI_full_par1h()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_par1h();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_par1h/data.mat';
vars.outpath   = 'LASSI_full_par1h.mat';
