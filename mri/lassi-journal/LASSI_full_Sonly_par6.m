function [vars, opts, vars0, opts0] = LASSI_full_Sonly_par6()
% Syntax:   [vars, opts, vars0, opts0] = LASSI_full_Sonly_par6();

% Knobs
vars.inpath    = 'otazo_full.mat';
vars.rawpath   = 'LASSI_full_Sonly_par6/data.mat';
vars.outpath   = 'LASSI_full_Sonly_par6.mat';
