function aggLADSfull_2_250b()
% Syntax: aggLADSfull_2_250b();

%{
% Knobs
% L + S init: 250 iteraions w/ lL = 1.1955 and lS = 0.01
inpath    = 'otazo_full_lads_2_250/data.mat';
outpath   = 'otazo_full_lads_2_250.mat';
...
inpath    = 'otazo_full_lads_2_250b/data.mat';
outpath   = 'otazo_full_lads_2_250b.mat';
ps        = [1/64, 1/32, 1/16, 1/8, 1/4, 1/2];
seed      = 1;
lambdaL   = 0.5;
lambdaS   = 0.01;
...
inpath    = 'otazo_full_lads_2_20/data.mat';
outpath   = 'otazo_full_lads_2_20.mat';
ps        = [1/64, 1/32, 1/16, 1/8, 1/4, 1/2];
seed      = 1;
lambdaL   = 0.5;
lambdaS   = 0.01;
