...
% Save data
%--------------------------------------------------------------------------
save(['C:\Users\brimoor\Desktop\InvivoPerfComparison_sigma_' int2str(round(sigma)) '.mat'],'IST','SLRN','-v7.3');
%save(['InvivoPerfComparison_sigma_' int2str(round(sigma)) '.mat'],'IST','SLRN','-v7.3');
%--------------------------------------------------------------------------
...
save(['InvivoPerfComparison_sigma_' int2str(round(sigma)) '_Results.mat'],'NRMSE_IST','NRMSE_IST2','NRMSE_SLRN','NRMSE_SLRN2','SNR_IST','SNR_IST2','SNR_SLRN','SNR_SLRN2','idx_IST','idx_SLRN');
