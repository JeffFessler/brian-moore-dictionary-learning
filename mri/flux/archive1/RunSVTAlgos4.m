...
%outpath = '/home/brimoor/Research/optshrink4mri/svt_LpS_mixed21/data.mat'; % Output data path
outpath = '/home/brimoor/Research/optshrink4mri/svt_LaS_mixed21/data.mat'; % Output data path
%--------------------------------------------------------------------------
...
labels = {'nc','nt','SNR','seed','lambdaL','lambdaS', ...
...
for i = 1:Ninds
    ...
    [~,recon,~,~,mask,ROIs,~,splineInterp] = run_svt_algo(nc(i),nt(i),SNR(i),seed(i),lambdaL(i),proxS,lambdaS(i),algoStr,T,Xtrue480,dce);
