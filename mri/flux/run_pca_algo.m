function [NRMSE recon Xtrue Xfft mask ROIs nd splineInterp] = run_pca_algo(nc,nt,SNR,seed,r,proxS,lambdaS,algoStr,T,Xtrue_full,dce)
% Syntax:   [NRMSE recon Xtrue Xfft mask ROIs nd splineInterp] = run_pca_algo(nc,nt,SNR,seed,r,proxS,lambdaS,algoStr,T,Xtrue_full,dce);
