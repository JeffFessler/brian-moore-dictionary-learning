function RunOptShrinkAlgos6(idx)
% Syntax:   RunOptShrinkAlgos6(idx);
...
%outpath = '/home/brimoor/Research/optshrink4mri/opt_LpS_soft/data.mat'; % Output data path
%inpath = '/home/brimoor/Research/optshrink4mri/dynobj2.mat'; % Ground truth data
%outpath = '/home/brimoor/Research/optshrink4mri/opt_LpS_soft2/data.mat'; % Output data path
inpath = '/home/brimoor/Research/optshrink4mri/dynobj3.mat'; % Ground truth data
outpath = '/home/brimoor/Research/optshrink4mri/opt_LaS_mixed21_3/data.mat'; % Output data path
%--------------------------------------------------------------------------
...
labels = {'nc','nt','SNR','seed','r','lambdaS','NRMSE','NRMSE_ROI1','NRMSE_ROI2','NRMSE_ROI3','NRMSE_ROI'}; %#ok
...
for i = 1:Ninds
    ...
    [~,recon,~,~,mask,ROIs,nd,splineInterp] = run_optshrink_algo(nc(i),nt(i),SNR(i),seed(i),r(i),proxS,lambdaS(i),algoStr,T,Xtrue_full,dce);
    if (r(i) > min(nd,nt(i)))
        % r was too large
        continue;
    end
